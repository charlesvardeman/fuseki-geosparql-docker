...
ENV GEO_FUSEKI_SHA512 c4733f4a3d80c64868c0db31116abee999eb2182f445bac9099d43f89a883dcbb2b02fda5689cd641f9af938227b148a0c874be3b1b78ad5cd5dc5712b51a2e4
...
RUN wget ${GEO_FUSEKI_DOWNLOAD}/v${GEO_FUSEKI_VERSION}/geosparql-fuseki-${GEO_FUSEKI_VERSION}-jena.zip \
    && sha512sum -c geosparql-fuseki-${GEO_FUSEKI_VERSION}-jena.zip.sha512 \
    && unzip geosparql-fuseki-${GEO_FUSEKI_VERSION}-jena.zip \
    && mv geosparql-fuseki-${GEO_FUSEKI_VERSION}-jena/* $FUSEKI_HOME \
    && rm geosparql-fuseki-${GEO_FUSEKI_VERSION}-jena.zip 
